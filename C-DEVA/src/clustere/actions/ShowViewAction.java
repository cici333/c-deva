...
public class ShowViewAction extends Action{
    ...
    private final String view1ID = "CDEVA.view1";
    private final String view3ID = "CDEVA.view3";
    private final String view4ID = "CDEVA.view4";
    private final String EdgeView = "CDEVA.EdgeView";
	...
	public ShowViewAction(final IWorkbenchWindow window){
		...
		setMenuCreator(new IMenuCreator() {
			public Menu getMenu(Menu parent) {
				...
				MenuItem edgeItem = new MenuItem(menu,SWT.NONE);
				edgeItem.setText("&Edges");
