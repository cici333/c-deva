			...
			public void widgetSelected(SelectionEvent e) {
		          ...
		          IEditorPart editor = workbenchPage.findEditor(editorInput);
		           if(editor!=null){
		        	   ...
		        	   try {
		        		   System.out.println("EDITOR:  "+editorID+"   "+editorInput.getName());
		           ...
		           System.out.println(treeElement.getNodes().size()+" ####### "+treeElement.getEdges().size());
