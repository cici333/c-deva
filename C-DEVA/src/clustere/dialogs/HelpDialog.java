...
public class HelpDialog extends org.eclipse.swt.widgets.Dialog {
	...
	public void open() {
		try {
			...
			dialogShell.setText("C-DEVA Help");
			...
			dialogShell.setSize(800,600);		
			{
				...
				System.out.println(dir);
					...
					item1.setText("C-DEVA Introduction");
					item1.setData("file://"+dir+"/help/C-DEVA1.html");
					item1 = new TreeItem(tree1,SWT.NONE);
					item1.setText("C-DEVA Basic Operation");
					item1.setData("file://"+dir+"/help/C-DEVA2.html");
					item1 = new TreeItem(tree1,SWT.NONE);
					item1.setText("C-DEVA Plug-in");
					item1.setData("file://"+dir+"/help/C-DEVA3.html");
					item1 = new TreeItem(tree1,SWT.NONE);
					item1.setText("C-DEVA Source API");
