...
import clustere.pluginAction.PluginEProteinAction;
...
//	public void addItem(MenuManager runMenu,MenuManager evaluationMenu, MenuManager predicitonMenu, MenuManager eProteinMenu, NewAlgorithm section){
...
//		}
//		else if(style == NewAlgorithm.ESSENTIAL_PROTEIN){
//			eProteinMenu.add(new PluginEProteinAction(section));
//		}
//	}
...
//			Paramater.uniqueCDEVAdge = Paramater.clusterEdges.get(treeitem); // 获取该树节点对应的簇中的边信息
...
//				"Nodes Num", "" + nodecount + "" });
//		int edgecount = Paramater.uniqueCDEVAdge.size();
