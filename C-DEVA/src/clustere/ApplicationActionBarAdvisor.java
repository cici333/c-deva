...
//    	predicitonMenu.add(new Separator());   
     ...
     */
    /*************************Esstial Protein****************************/ 
//    	MenuManager eProteinMenu = new MenuManager("&EssentialProtein","EssentialProtein");
//    	eProteinMenu.add(new Separator()); 
...
//    	fillPluginMenu(runMenu, evaluationMenu, predicitonMenu, eProteinMenu);
...
//    protected void fillPluginMenu(MenuManager runMenu,MenuManager evaluationMenu, MenuManager predicitonMenu, MenuManager eproteinMenu){
//    	for(int i=0;i<LoaderServer.pluginList.size();i++){
//    		LoadManage.getInstance().addItem(runMenu, evaluationMenu, predicitonMenu, eproteinMenu, LoaderServer.pluginList.get(i));
//
//    	}
//    }
